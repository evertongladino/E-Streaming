...
INSERT INTO `tb_assunto` VALUES (1,'Assunto 1',1,'2017-10-30 17:41:00',1,1,2),(2,'Assunto 2',1,'2017-10-30 17:47:32',1,1,3);
...
INSERT INTO `tb_completar` VALUES ('Complete as lacunas abaixo corretamente de forma a dar sentido ao texto abaixo:',1,1,1,1432,4,'A Internet é um conjunto de _____ unidas através do protocolo __, que atua como um meio de comunicação _________ entre os diferentes tipos de rede. Por meio da Internet, é possível compartilhar conteúdo multimídia via ___.','2017-10-26 19:16:40',3,'0'),('Complete as lacunas abaixo corretamente de forma a dar sentido ao texto abaixo:',2,1,3,0,1,'O nome oficial do Brasil é República __________ do Brasil.','2017-10-30 18:24:09',3,'\0');
...
INSERT INTO `tb_completar_alternativas` VALUES (1,1,'redes',1,1),(2,2,'ip',1,1),(3,3,'universal',1,1),(4,4,'web',1,1);
...
INSERT INTO `tb_curso` VALUES (0,'Ciencia da computacao',1,9,'2017-10-30 17:41:57',4,'1');
...
INSERT INTO `tb_disciplina` VALUES (1,'Arq. de Sistemas Distribuídos',1,'2017-11-12 10:50:38',7),(2,'Introd. à Internet',1,'2017-11-12 10:50:38',3),(3,'Direito Penal',1,'2017-11-12 10:50:38',4);
...
INSERT INTO `tb_faculdade` VALUES (2,'FATECS',4,1,'2017-10-30 17:41:39','1');
...
INSERT INTO `tb_instituicao` VALUES (1,'32313123','CEUB','Asa Norte','45687','45679','4564','email','dsadsd.com','2017-10-30 17:41:17',1,'CEUBINHO');
...
INSERT INTO `tb_midia` VALUES (1,'/var/www/html/estreaming/WEB-INF/uploads/teste.pdf',1,1,'2017-10-24 18:56:26'),(2,'/var/www/html/estreaming/WEB-INF/uploads/cachorrinho_se_cocando.mp4',2,1,'2017-10-24 18:56:26'),(3,'/var/www/html/estreaming/WEB-INF/uploads/mario-sergio-cortella-sobre-a-internet.mp3',3,1,'2017-10-24 18:56:26'),(4,'/var/www/html/estreaming/WEB-INF/uploads/negao_da_picona.jpg',4,0,'2017-10-30 18:58:26');
...
INSERT INTO `tb_tipo_midia` VALUES (1,'Texto',1),(2,'Vídeo',1),(3,'Áudio',1),(4,'Imagem',1);
...
INSERT INTO `tb_tipo_questao` VALUES (1,'Verdadeiro ou Falso'),(2,'Múltipla Escolha'),(3,'Completar'),(4,'Somatório');
...
INSERT INTO `tb_usuario` VALUES (2,'234234343','Prof. Teste','teste@teste.com','202cb962ac59075b964b07152d234b70','4','2017-10-22 21:31:49',1,'1',11111111),(9,'11111111111','Fulano de Tal','a@a.com','202cb962ac59075b964b07152d234b70','4','2017-10-22 19:17:29',1,NULL,40028922);
...
-- Dump completed on 2017-11-12 10:54:39
